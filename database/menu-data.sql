-- =============================================
-- Horchata Mexican Food - Datos del Menú
...
UPDATE `settings` SET `setting_value` = '8.25' WHERE `setting_key` = 'tax_rate';

-- Actualizar configuración de moneda
UPDATE `settings` SET `setting_value` = 'USD' WHERE `setting_key` = 'currency';
