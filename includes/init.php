...
function __($key, $default = '') {
    ...
    $texts_es = [
        ...
        'contact_form_desc' => 'Completa el formulario y nos pondremos en contacto contigo a la brevedad.',
        ...
        'newsletter_opt_in' => 'Deseo recibir noticias y promociones',
        'our_location' => 'Nuestra Ubicación',
        'pickup_service' => 'Servicio de Pickup',
        'pickup_service_desc' => 'Haz tu pedido en línea y recógelo en el restaurante sin filas.',
        'quality_commitment' => 'Compromiso de Calidad',
        'quality_commitment_desc' => 'Preparamos cada platillo con ingredientes frescos y el mayor cuidado.',
        'please_complete_fields' => 'Por favor completa los campos requeridos',
        'sending' => 'Enviando',
        'message_sent_title' => '¡Mensaje enviado!',
        'message_sent_text' => 'Gracias por contactarnos. Te responderemos lo antes posible.',
        'location' => 'Ubicación',
        'hours' => 'Horarios',
        ...
        'contact_messages_management' => 'Gestión de Mensajes de Contacto',
        'contact_message_details' => 'Detalles del Mensaje',
        'new_messages' => 'Nuevos',
        'read' => 'Leídos',
        'replied' => 'Respondidos',
        'archived' => 'Archivados',
        ...
        'sender_information' => 'Información del Remitente',
        ...
        'archive' => 'Archivar',
        'reply' => 'Responder',
        'change_message_status_confirm' => '¿Cambiar el estado del mensaje?',
        'delete_message_confirm' => '¿Eliminar este mensaje?',
        'subscribed_newsletter' => 'Suscrito al boletín',
        'print_order' => 'Imprimir Pedido',
        ...
        // AJAX Messages
        'invalid_action' => 'Acción no válida',
        'cart_prepared' => 'Carrito preparado para checkout',
        'cart_updated' => 'Carrito actualizado',
        'cart_cleared' => 'Carrito limpiado',
        'no_cart_data' => 'No hay datos del carrito',
        'error_decoding_cart' => 'Error al decodificar datos del carrito',
        ...
        'order_marked_paid_successfully' => 'Pedido marcado como pagado exitosamente',
        ...
        'product_status_updated' => 'Producto {status} exitosamente',
        'image_uploaded_successfully' => 'Imagen subida exitosamente',
        'data_saved_automatically' => 'Datos guardados automáticamente',
        ...
        'user_status_updated_successfully' => 'Estado de usuario actualizado exitosamente',
        'extra_created_successfully' => 'Extra creado exitosamente',
        'extra_assigned_to_product' => 'Extra asignado al producto',
        'extra_removed_from_product' => 'Extra removido del producto',
        'message_status_updated' => 'Estado actualizado correctamente',
        'message_deleted_successfully' => 'Mensaje eliminado correctamente',
        'error_loading_products' => 'Error al cargar productos',
        'error_loading_categories' => 'Error al cargar las categorías',
        'error_loading_public_reviews' => 'Error al cargar las reseñas públicas',
        'review_submitted_successfully' => 'Reseña enviada exitosamente',
        'error_saving_message' => 'Error al guardar el mensaje',
        'order_data_not_received' => 'Datos de orden no recibidos',
        'invalid_order_data' => 'Datos de orden no válidos',
        'required_field_missing' => 'Campo requerido faltante: {field}',
        'error_inserting_order' => 'Error al insertar la orden',
        'error_inserting_order_item' => 'Error al insertar item de la orden: {item}',
        'error_updating_review_token' => 'Error al actualizar el token de revisión',
        ...
        'error_updating_product_status' => 'Error al actualizar el estado del producto',
        'error_file_upload' => 'Error en la subida del archivo (código: {code})',
        'error_saving_file' => 'Error al guardar el archivo en el servidor',
        'error_updating_order_status' => 'Error al actualizar el estado del pedido',
        'error_updating_payment_status' => 'Error actualizando el estado del pago',
        'error_creating_user' => 'Error al crear el usuario',
        'error_updating_user' => 'Error actualizando el usuario',
        'error_deleting_user' => 'Error eliminando el usuario',
        'error_updating_user_status' => 'Error actualizando el estado del usuario',
        'error_updating_message_status' => 'Error al actualizar el estado del mensaje',
        'error_deleting_message' => 'Error al eliminar el mensaje',
        'internal_server_error' => 'Error interno del servidor',
        'order_id_required' => 'ID de orden requerido',
        'order_not_found' => 'Orden no encontrada',
        'order_id_status_required' => 'ID de orden y estado requeridos',
        ...
        'order_already_paid' => 'El pedido ya está marcado como pagado',
        'invalid_product_id' => 'ID de producto inválido',
        'invalid_element_id' => 'ID de elemento inválido',
        'product_activated' => 'Producto activado',
        'product_deactivated' => 'Producto desactivado',
        'invalid_element_type' => 'Tipo de elemento no válido',
        'invalid_export_format' => 'Formato de exportación no válido',
        ...
        'username_email_exists' => 'El usuario o correo ya existe',
        'password_min_length' => 'La contraseña debe tener al menos 6 caracteres',
        'all_fields_required' => 'Todos los campos requeridos deben estar completos',
        ...
        'invalid_ids' => 'IDs inválidos',
        'invalid_status' => 'Estado inválido',
        'token_required' => 'Token requerido',
        'invalid_rating' => 'Calificación inválida',
        'review_text_required' => 'Texto de reseña requerido',
        'invalid_or_expired_token' => 'Token inválido o expirado',
        'review_already_exists' => 'Ya existe una reseña para esta orden',
        'error_saving_review' => 'Error al guardar la reseña',
    ...
    $texts_en = [
        ...
        'contact_form_desc' => 'Fill out the form and we will get back to you shortly.',
        'full_name' => 'Full Name',
        ...
        'newsletter_opt_in' => 'I want to receive news and promotions',
        'our_location' => 'Our Location',
        'pickup_service' => 'Pickup Service',
        'pickup_service_desc' => 'Place your order online and pick it up at the restaurant without lines.',
        'quality_commitment' => 'Quality Commitment',
        'quality_commitment_desc' => 'We prepare each dish with fresh ingredients and the greatest care.',
        'please_complete_fields' => 'Please complete the required fields',
        'sending' => 'Sending',
        'message_sent_title' => 'Message sent!',
        'message_sent_text' => 'Thank you for contacting us. We will reply as soon as possible.',
        'location' => 'Location',
        'hours' => 'Hours',
        'phone_number' => '+1 (310) 204-2659',
        'address_full' => '10814 Jefferson Blvd<br>Culver City, CA',
        ...
        'archive' => 'Archive',
        'reply' => 'Reply',
        'change_message_status_confirm' => 'Change message status?',
        ...
        // AJAX Messages
        'invalid_action' => 'Invalid action',
        'cart_prepared' => 'Cart prepared for checkout',
        'cart_updated' => 'Cart updated',
        'cart_cleared' => 'Cart cleared',
        'no_cart_data' => 'No cart data',
        'error_decoding_cart' => 'Error decoding cart data',
        'cart_empty' => 'Cart is empty',
        'server_error' => 'Server error',
        'order_created_successfully' => 'Order created successfully',
        'status_updated_successfully' => 'Status updated successfully',
        'order_status_updated_successfully' => 'Order status updated successfully',
        'order_marked_paid_successfully' => 'Order marked as paid successfully',
        'unauthorized' => 'Unauthorized',
        'product_created_successfully' => 'Product created successfully',
        'product_updated_successfully' => 'Product updated successfully',
        'product_deleted_successfully' => 'Product deleted successfully',
        'product_status_updated' => 'Product {status} successfully',
        'image_uploaded_successfully' => 'Image uploaded successfully',
        'data_saved_automatically' => 'Data saved automatically',
        ...
        'extra_assigned_to_product' => 'Extra assigned to product',
        'extra_removed_from_product' => 'Extra removed from product',
        'message_status_updated' => 'Status updated correctly',
        ...
        'order_data_not_received' => 'Order data not received',
        'invalid_order_data' => 'Invalid order data',
        'required_field_missing' => 'Required field missing: {field}',
        'error_inserting_order' => 'Error inserting order',
        'error_inserting_order_item' => 'Error inserting order item: {item}',
        'error_updating_review_token' => 'Error updating review token',
        ...
        'error_updating_product_status' => 'Error updating product status',
        'error_file_upload' => 'Error uploading file (code: {code})',
        'error_saving_file' => 'Error saving file to server',
        ...
        'error_updating_message_status' => 'Error updating message status',
        'error_deleting_message' => 'Error deleting message',
        'internal_server_error' => 'Internal server error',
        'order_id_required' => 'Order ID required',
        'order_not_found' => 'Order not found',
        'order_id_status_required' => 'Order ID and status required',
        ...
        'review_text_required' => 'Review text required',
        'invalid_or_expired_token' => 'Invalid or expired token',
        'review_already_exists' => 'Review already exists for this order',
