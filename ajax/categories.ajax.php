...
function getCategories() {
    ...
    try {
        ...
        // Según el schema, la tabla categories tiene: id, name_en, name_es, description_en, description_es, image, sort_order, is_active
        // NO tiene: icon, color, display_order
        // Usaremos solo las columnas que existen en el schema
